...
export function usageText() {
  return [
    ...
    "",
    "Use `regents shader ...` for local shader export.",
    "Use `regents platform ...` to sign in, check launch readiness, add billing, launch a company, and manage runtime state from the terminal.",
    "",
    ...
    "regents platform billing setup --claimed-label <label>",
    "regents platform company create --claimed-label <label>",
    "regents platform company runtime --slug <slug>",
    "",
    "Commands:",
    ...shaderUsageLines(),
    ...platformUsageLines(),
