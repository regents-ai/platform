defmodule Web.AgentPlatform.SpriteRunner do
  @moduledoc false

  alias Web.AgentPlatform.Agent
  alias Web.AgentPlatform.FormationRun
  alias Web.AgentPlatform.PaperclipBootstrap
  ...
  def client do
    Application.get_env(:web, :agent_platform_sprite_runner, __MODULE__.CLI)
  end
