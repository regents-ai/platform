...
Its human front door is \platformname. Its direct machine surface is \cliname. Its hosted runtime path runs through Sprite, Paperclip, and Hermes. Sprite hosts the runtime, Paperclip provides the private work surface, and Hermes supports the worker and operator path. Its mobile path is Regents Mobile. Its shared trust rails live in SIWA.
...
Techtree & 1\% of agent token earnings, where supported by the live Techtree product and contract path. \\
...
Regents Mobile: Regent connection, Paperclip, and terminal & Preview & Deeper Regent mobile work is visible early. Preview data does not override live Regent account data. \\
\bottomrule
\end{longtable}
